...
const orderedWorkspaces = workspaces((list: AstalHyprland.Workspace[]) => list.toSorted((ws1: AstalHyprland.Workspace, ws2: AstalHyprland.Workspace) => {
  if (ws1.id > ws2.id) {
    return 1;
